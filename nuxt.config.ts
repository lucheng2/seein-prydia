...
export default defineNuxtConfig({
  ...
  modules: ['@element-plus/nuxt', '@nuxt/eslint', '@unocss/nuxt', '@vueuse/nuxt', 'dayjs-nuxt', '@pinia/nuxt', 'pinia-plugin-persistedstate/nuxt'],
  vue: {
    compilerOptions: {
  ...
  css: ['@unocss/reset/normalize.css', '@unocss/reset/sanitize/sanitize.css', '@unocss/reset/sanitize/assets.css', '~/assets/styles/element/main.scss', '~/assets/styles/index.scss'],
  vite: {
    plugins: [
    ...
    css: {
      preprocessorOptions: {
        scss: {
          api: 'modern-compiler',
          additionalData: '@use "~/assets/styles/element/index.scss" as element; @use "@/assets/styles/variables.scss" as *;',
        },
      },
    },
    esbuild: {
      drop: ['debugger'],
      pure: process.env.VITE_NODE_ENV === 'production' ? ['console.log', 'console.info'] : [], // Use NUXT_ENV to distinct between test and production
    },
    // lamejs 配置
    optimizeDeps: {
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {
          name: 'keywords',
          content: 'AI,心理课程,心理咨询,心理培训,心理服务,心理治疗,抑郁症治疗,焦虑症干预,婚姻家庭咨询',
        },
