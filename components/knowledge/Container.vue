      ...
      const mockArticles: Article[] = [
        {
          id: '1',
          title:
            'Understanding Artificial Intelligence: From Machine Learning to Deep Learning',
          summary:
            'This article explores the development of artificial intelligence, from basic machine learning algorithms to modern deep learning technologies, helping readers build a correct AI cognitive framework.',
          content:
        ...
        },
        {
          id: '2',
          title:
            'Climate Change and Environmental Protection: Scientific Facts We Need to Know',
          summary:
            'Climate change is one of the major challenges facing the world today. Based on the latest scientific research, this article introduces the causes, impacts, and countermeasures of climate change.',
          content:
        ...
        },
        {
          id: '3',
          title:
            'Quantum Computing: Scientific Principles of Next-Generation Computing Technology',
          summary:
            'Quantum computing represents the future direction of computing technology. Learn how quantum mechanics principles are applied to the computing field and how quantum computers work.',
          content:
