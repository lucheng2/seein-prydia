...
<template>
  <div ref="containerRef" class="relative h-full w-full">
    <!-- 在服务端渲染时显示占位内容，避免布局闪烁 -->
    <div v-if="!isClient" class="h-full w-full animate-pulse from-purple-900/20 to-blue-900/20 bg-gradient-to-br"></div>
  </div>
</template>
